...
// VerrazzanoOwnerLabel is the label for the verrazzano CR that owns the resource
const VerrazzanoOwnerLabel = "module.verrazzano.io/vz-owner"

// VerrazzanoModuleOwnerLabel is the label for the module CR that owns the resource
