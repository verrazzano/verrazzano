...
func convertComponentsTo(src ComponentSpec) (v1beta1.ComponentSpec, error) {
	...
	return v1beta1.ComponentSpec{
		...
		FluentbitOCILoggingAnalyticsOutput: convertFluentbitOCILoggingAnalyticsOutputToV1Beta1(src.FluentbitOCILoggingAnalyticsOutput),
	}, nil
}
...
func convertFluentbitOCILoggingAnalyticsOutputToV1Beta1(src *FluentbitOCILoggingAnalyticsOutputComponent) *v1beta1.FluentbitOCILoggingAnalyticsOutputComponent {
	if src == nil {
		return nil
	}
