...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OLMComponent) DeepCopyInto(out *OLMComponent) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OLMComponent.
func (in *OLMComponent) DeepCopy() *OLMComponent {
	if in == nil {
		return nil
	}
	out := new(OLMComponent)
