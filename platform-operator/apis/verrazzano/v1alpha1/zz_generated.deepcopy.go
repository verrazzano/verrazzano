...
func (in *VeleroComponent) DeepCopyInto(out *VeleroComponent) {
	*out = *in
	...
	if in.Kubernetes != nil {
		in, out := &in.Kubernetes, &out.Kubernetes
		*out = new(VeleroKubernetesSection)
		(*in).DeepCopyInto(*out)
	}
	if in.Restic != nil {
		in, out := &in.Restic, &out.Restic
		*out = new(VeleroResticSection)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VeleroKubernetesSection) DeepCopyInto(out *VeleroKubernetesSection) {
	*out = *in
	if in.Resources != nil {
		in, out := &in.Resources, &out.Resources
		*out = new(v1.ResourceRequirements)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VeleroKubernetesSection.
func (in *VeleroKubernetesSection) DeepCopy() *VeleroKubernetesSection {
	if in == nil {
		return nil
	}
	out := new(VeleroKubernetesSection)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VeleroResticSection) DeepCopyInto(out *VeleroResticSection) {
	*out = *in
	if in.Kubernetes != nil {
		in, out := &in.Kubernetes, &out.Kubernetes
		*out = new(VeleroKubernetesSection)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VeleroResticSection.
func (in *VeleroResticSection) DeepCopy() *VeleroResticSection {
	if in == nil {
		return nil
	}
	out := new(VeleroResticSection)
