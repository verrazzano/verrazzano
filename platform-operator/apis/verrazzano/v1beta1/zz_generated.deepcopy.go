...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterIssuerRef) DeepCopyInto(out *ClusterIssuerRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterIssuerRef.
func (in *ClusterIssuerRef) DeepCopy() *ClusterIssuerRef {
	if in == nil {
		return nil
	}
	out := new(ClusterIssuerRef)
	in.DeepCopyInto(out)
	return out
}
