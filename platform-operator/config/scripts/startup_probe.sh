...
curl -kfs -o /dev/null "${URL}/validate-install-verrazzano-io-v1alpha1-verrazzano" \
&& curl -kfs -o /dev/null "${URL}/validate-install-verrazzano-io-v1beta1-verrazzano" \
&& curl -kfs -o /dev/null "${URL}/validate-clusters-verrazzano-io-v1alpha1-verrazzanomanagedcluster" \
