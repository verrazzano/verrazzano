...
import (
	...
	v1alpha1 "github.com/verrazzano/verrazzano/platform-operator/apis/modules/v1alpha1"
	v1alpha10 "github.com/verrazzano/verrazzano/platform-operator/apis/verrazzano/v1alpha1"
...
func (m *MockComponentContext) ActualCR() *v1alpha10.Verrazzano {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ActualCR")
	ret0, _ := ret[0].(*v1alpha10.Verrazzano)
	return ret0
}
...
func (m *MockComponentContext) EffectiveCR() *v1alpha10.Verrazzano {
	m.ctrl.T.Helper()
...
func (m *MockComponentContext) Module() *v1alpha1.Module {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Module")
	ret0, _ := ret[0].(*v1alpha1.Module)
	return ret0
}

// Module indicates an expected call of Module
func (mr *MockComponentContextMockRecorder) Module() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Module", reflect.TypeOf((*MockComponentContext)(nil).Module))
}
...
func (m *MockComponentInfo) IsAvailable(arg0 spi.ComponentContext) (string, v1alpha10.ComponentAvailability) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsAvailable", arg0)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(v1alpha10.ComponentAvailability)
	return ret0, ret1
}
...
// IsAvailable mocks base method
func (m *MockComponent) IsAvailable(arg0 spi.ComponentContext) (string, v1alpha10.ComponentAvailability) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsAvailable", arg0)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(v1alpha10.ComponentAvailability)
...
func (m *MockComponent) ValidateInstall(arg0 *v1alpha10.Verrazzano) error {
	m.ctrl.T.Helper()
...
func (m *MockComponent) ValidateUpdate(arg0, arg1 *v1alpha10.Verrazzano) error {
	m.ctrl.T.Helper()
