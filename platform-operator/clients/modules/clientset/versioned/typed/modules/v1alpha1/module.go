...
import (
	...
	scheme "github.com/verrazzano/verrazzano/platform-operator/clients/modules/clientset/versioned/scheme"
...
func newModules(c *ModulesV1alpha1Client, namespace string) *modules {
	return &modules{
		client: c.RESTClient(),
		ns:     namespace,
	}
