...
import (
	...
	"github.com/verrazzano/verrazzano/platform-operator/clients/modules/clientset/versioned/scheme"
...
// ModulesV1alpha1Client is used to interact with features provided by the modules group.
type ModulesV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ModulesV1alpha1Client) Modules(namespace string) ModuleInterface {
...
// NewForConfigAndClient creates a new ModulesV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ModulesV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
