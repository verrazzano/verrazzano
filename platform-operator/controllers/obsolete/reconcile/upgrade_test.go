...
func TestInstanceRestoreWithEmptyStatus(t *testing.T) {
	...
	c := fake.NewClientBuilder().WithScheme(k8scheme.Scheme).WithObjects(&verrazzanoToUse,
		...
		&networkingv1.Ingress{
			ObjectMeta: metav1.ObjectMeta{Namespace: constants.VerrazzanoSystemNamespace, Name: constants.OpensearchIngress},
			Spec: networkingv1.IngressSpec{
				Rules: []networkingv1.IngressRule{
					{Host: esURL},
				},
		...
		&networkingv1.Ingress{
			ObjectMeta: metav1.ObjectMeta{Namespace: constants.VerrazzanoSystemNamespace, Name: constants.OpensearchDashboardsIngress},
			Spec: networkingv1.IngressSpec{
				Rules: []networkingv1.IngressRule{
					{Host: kibanaURL},
				},
