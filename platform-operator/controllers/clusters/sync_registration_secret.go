...
const defaultElasticURL = "http://verrazzano-authproxy-elasticsearch:9200"
...
func (r *VerrazzanoManagedClusterReconciler) mutateRegistrationSecret(secret *corev1.Secret, manageClusterName string) error {
	...
	// If the fluentd ELASTICSEARCH_URL is the default "http://verrazzano-authproxy-elasticsearch:9200", use VMI ES ingress URL.
