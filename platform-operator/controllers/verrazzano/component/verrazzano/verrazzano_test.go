			...
			actualCR: vzapi.Verrazzano{
				Spec: vzapi.VerrazzanoSpec{
					...
					Components: vzapi.ComponentSpec{
						...
						Fluentd:                   &vzapi.FluentdComponent{Enabled: &trueValue},
						FluentOperator:            &vzapi.FluentOperatorComponent{Enabled: &trueValue},
						FluentbitOpensearchOutput: &vzapi.FluentbitOpensearchOutputComponent{Enabled: &trueValue},
					},
				},
			},
