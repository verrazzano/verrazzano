...
const (
	...
	fluentbitVolumeMountNameKey        = "fluentbit.additionalVolumesMounts[0].name"
	fluentbitVolumeMountPathKey        = "fluentbit.additionalVolumesMounts[0].mountPath"
	fluentbitVolumeMountReadOnlyKey    = "fluentbit.additionalVolumesMounts[0].readOnly"
