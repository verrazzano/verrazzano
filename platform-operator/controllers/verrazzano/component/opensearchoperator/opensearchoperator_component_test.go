...
var (
	opensearchDisabled = v1alpha1.OpenSearchOperatorComponent{
	...
	opensearchDashboardsDisbaled = v1alpha1.OpenSearchOperatorComponent{
		InstallOverrides: v1alpha1.InstallOverrides{
			ValueOverrides: []v1alpha1.Overrides{{
				Values: &v1.JSON{
	...
	opensearchAndOsdDisabled = v1alpha1.OpenSearchOperatorComponent{
		InstallOverrides: v1alpha1.InstallOverrides{
			ValueOverrides: []v1alpha1.Overrides{{
				Values: &v1.JSON{
