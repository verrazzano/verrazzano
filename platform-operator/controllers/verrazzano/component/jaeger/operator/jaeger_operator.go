...
func GetHelmManagedResources() []common.HelmManagedResource {
	return []common.HelmManagedResource{
		...
		{Obj: &adminv1.ValidatingWebhookConfiguration{}, NamespacedName: types.NamespacedName{Name: "jaeger-operator-mutating-webhook-configuration", Namespace: ComponentNamespace}},
