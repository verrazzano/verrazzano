...
type getCertManagerClientFuncType func(...string) (certv1client.CertmanagerV1Interface, error)
...
func validateCAConfiguration(ca vzapi.CA) error {
	...
	_, err = v1Client.Secrets(ca.ClusterResourceNamespace).Get(context.TODO(), ca.SecretName, metav1.GetOptions{})
	return err
}
