...
func (h HelmComponent) PreUpdate(context spi.ComponentContext) error {
	return nil
}

func (h HelmComponent) Update(context spi.ComponentContext) error {
	return h.Upgrade(context)
}

func (h HelmComponent) PostUpdate(context spi.ComponentContext) error {
	return nil
}
