...
func TestGetComponents(t *testing.T) {
	...
	a.Len(comps, 15, "Wrong number of components")
	a.Equal(comps[0].Name(), oam.ComponentName)
	a.Equal(comps[1].Name(), weblogic.ComponentName)
	a.Equal(comps[2].Name(), appoper.ComponentName)
	a.Equal(comps[3].Name(), istio.ComponentName)
	...
	a.Equal(comps[14].Name(), prometheusoper.ComponentName)
}
