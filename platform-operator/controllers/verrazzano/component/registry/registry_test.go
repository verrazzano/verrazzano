...
func TestGetComponents(t *testing.T) {
	...
	assert.Equal(comps[3].Name(), nginx.ComponentName)
	assert.Equal(comps[4].Name(), certmanager.ComponentName)
	assert.Equal(comps[5].Name(), externaldns.ComponentName)
	assert.Equal(comps[6].Name(), rancher.ComponentName)
	assert.Equal(comps[7].Name(), verrazzano.ComponentName)
	assert.Equal(comps[8].Name(), authproxy.ComponentName)
	assert.Equal(comps[9].Name(), coherence.ComponentName)
	assert.Equal(comps[10].Name(), weblogic.ComponentName)
