...
func TestReconcileUninstall2(t *testing.T) {
	...
	k8sutil.GetCoreV1Func = common.MockGetCoreV1(&corev1.Namespace{
		ObjectMeta: metav1.ObjectMeta{
			Name: constants.RancherSystemNamespace,
			Labels: map[string]string{
				constants.LabelVerrazzanoNamespace: constants.RancherSystemNamespace,
			},
		},
	},
	)
