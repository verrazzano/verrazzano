...
```bash
$ kubectl apply -f https://github.com/cert-manager/cert-manager/releases/download/v1.9.1-8-g368f75e8f601a5/cert-manager.crds.yaml
```
...
$ helm install my-release --namespace cert-manager --version v1.9.1-8-g368f75e8f601a5 jetstack/cert-manager
```
...
```console
$ kubectl delete -f https://github.com/cert-manager/cert-manager/releases/download/v1.9.1-8-g368f75e8f601a5/cert-manager.crds.yaml
```
...
| `image.tag` | Image tag | `v1.9.1-8-g368f75e8f601a5` |
...
| `webhook.image.tag` | Webhook image tag | `v1.9.1-8-g368f75e8f601a5` |
...
| `cainjector.image.tag` | cainjector image tag | `v1.9.1-8-g368f75e8f601a5` |
...
| `startupapicheck.image.tag` | startupapicheck image tag | `v1.9.1-8-g368f75e8f601a5` |
