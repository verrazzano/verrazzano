...
if [ $display_warning_for_secret == "true" ]; then
  consoleout
  consoleout "WARNING: Do not edit one or more secrets mentioned above to reset the password. They are provided here for convenient access to various consoles."
  consoleout
fi
