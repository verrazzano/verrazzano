...
CHARTS_DIR=${CHARTS_DIR:-$(cd $SOURCE_DIR/../../../thirdparty/charts; pwd -P)}
VZ_CHARTS_DIR=${VZ_CHARTS_DIR:-$(cd $SOURCE_DIR/../../../helm_config/charts; pwd -P)}
VZ_OVERRIDES_DIR=${VZ_OVERRIDES_DIR:-$(cd $SOURCE_DIR/../../../helm_config/overrides; pwd -P)}
MANIFESTS_DIR=${MANIFESTS_DIR:-$(cd $SOURCE_DIR/../../../thirdparty/manifests; pwd -P)}
