...
func (c *VerrazzanoV1beta2Client) ModuleDefinitions(namespace string) ModuleDefinitionInterface {
	return newModuleDefinitions(c, namespace)
}

func (c *VerrazzanoV1beta2Client) OperatorDefinitions(namespace string) OperatorDefinitionInterface {
...
func (c *VerrazzanoV1beta2Client) VerrazzanoModules(namespace string) VerrazzanoModuleInterface {
