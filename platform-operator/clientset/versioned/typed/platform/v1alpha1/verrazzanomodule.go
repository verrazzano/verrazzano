...
type VerrazzanoModuleInterface interface {
	Create(ctx context.Context, verrazzanoModule *v1alpha1.VerrazzanoModule, opts v1.CreateOptions) (*v1alpha1.VerrazzanoModule, error)
	Update(ctx context.Context, verrazzanoModule *v1alpha1.VerrazzanoModule, opts v1.UpdateOptions) (*v1alpha1.VerrazzanoModule, error)
	UpdateStatus(ctx context.Context, verrazzanoModule *v1alpha1.VerrazzanoModule, opts v1.UpdateOptions) (*v1alpha1.VerrazzanoModule, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.VerrazzanoModule, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.VerrazzanoModuleList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VerrazzanoModule, err error)
...
func newVerrazzanoModules(c *PlatformV1alpha1Client, namespace string) *verrazzanoModules {
...
func (c *verrazzanoModules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VerrazzanoModule, err error) {
	result = &v1alpha1.VerrazzanoModule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *verrazzanoModules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VerrazzanoModuleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.VerrazzanoModuleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("verrazzanomodules").
...
func (c *verrazzanoModules) Create(ctx context.Context, verrazzanoModule *v1alpha1.VerrazzanoModule, opts v1.CreateOptions) (result *v1alpha1.VerrazzanoModule, err error) {
	result = &v1alpha1.VerrazzanoModule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("verrazzanomodules").
...
func (c *verrazzanoModules) Update(ctx context.Context, verrazzanoModule *v1alpha1.VerrazzanoModule, opts v1.UpdateOptions) (result *v1alpha1.VerrazzanoModule, err error) {
	result = &v1alpha1.VerrazzanoModule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("verrazzanomodules").
...
func (c *verrazzanoModules) UpdateStatus(ctx context.Context, verrazzanoModule *v1alpha1.VerrazzanoModule, opts v1.UpdateOptions) (result *v1alpha1.VerrazzanoModule, err error) {
	result = &v1alpha1.VerrazzanoModule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("verrazzanomodules").
...
func (c *verrazzanoModules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VerrazzanoModule, err error) {
	result = &v1alpha1.VerrazzanoModule{}
