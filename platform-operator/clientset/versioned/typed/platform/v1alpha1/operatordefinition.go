...
type OperatorDefinitionInterface interface {
	Create(ctx context.Context, operatorDefinition *v1alpha1.OperatorDefinition, opts v1.CreateOptions) (*v1alpha1.OperatorDefinition, error)
	Update(ctx context.Context, operatorDefinition *v1alpha1.OperatorDefinition, opts v1.UpdateOptions) (*v1alpha1.OperatorDefinition, error)
	UpdateStatus(ctx context.Context, operatorDefinition *v1alpha1.OperatorDefinition, opts v1.UpdateOptions) (*v1alpha1.OperatorDefinition, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.OperatorDefinition, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.OperatorDefinitionList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OperatorDefinition, err error)
...
func (c *operatorDefinitions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OperatorDefinitionList, err error) {
