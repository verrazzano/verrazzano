...
GENERATED_CLIENT_DIR=$SCRIPT_ROOT/client-clusters
...
${CODEGEN_PKG}/generate-groups.sh "client" \
  github.com/verrazzano/verrazzano/platform-operator/client-clusters github.com/verrazzano/verrazzano/platform-operator/apis \
  clusters:v1alpha1 \
