...
func initMetricComponentMap() map[metricName]*MetricsComponent {
	return map[metricName]*MetricsComponent{
		authproxyMetricName:            newMetricsComponent(authproxy.ComponentName),
		oamMetricName:                  newMetricsComponent(oam.ComponentName),
		appoperMetricName:              newMetricsComponent(appoper.ComponentName),
		istioMetricName:                newMetricsComponent(istio.ComponentName),
		weblogicMetricName:             newMetricsComponent(weblogic.ComponentName),
		nginxMetricName:                newMetricsComponent(nginx.ComponentName),
		certmanagerMetricName:          newMetricsComponent(certmanager.ComponentName),
		clusterOperatorMetricName:      newMetricsComponent(clusteroperator.ComponentName),
		externaldnsMetricName:          newMetricsComponent(externaldns.ComponentName),
		rancherMetricName:              newMetricsComponent(rancher.ComponentName),
		verrazzanoMetricName:           newMetricsComponent(verrazzano.ComponentName),
		vmoMetricName:                  newMetricsComponent(vmo.ComponentName),
		opensearchMetricName:           newMetricsComponent(opensearch.ComponentName),
		opensearchdashboardsMetricName: newMetricsComponent(opensearchdashboards.ComponentName),
		grafanaMetricName:              newMetricsComponent(grafana.ComponentName),
		coherenceMetricName:            newMetricsComponent(coherence.ComponentName),
		mysqlMetricName:                newMetricsComponent(mysql.ComponentName),
		mysqlOperatorMetricName:        newMetricsComponent(mysqloperator.ComponentName),
		keycloakMetricname:             newMetricsComponent(keycloak.ComponentName),
		kialiMetricName:                newMetricsComponent(kiali.ComponentName),
		promoperatorMetricname:         newMetricsComponent(promoperator.ComponentName),
		promadapterMetricname:          newMetricsComponent(promadapter.ComponentName),
		kubestatemmetricsMetricName:    newMetricsComponent(kubestatemetrics.ComponentName),
		pushgatewayMetricName:          newMetricsComponent(pushgateway.ComponentName),
		promnodeexporterMetricname:     newMetricsComponent(promnodeexporter.ComponentName),
		jaegeroperatorMetricName:       newMetricsComponent(jaegeroperator.ComponentName),
		consoleMetricName:              newMetricsComponent(console.ComponentName),
		fluentdMetricName:              newMetricsComponent(fluentd.ComponentName),
		veleroMetricName:               newMetricsComponent(velero.ComponentName),
		rancherBackupMetricName:        newMetricsComponent(rancherbackup.ComponentName),
		networkpoliciesMetricName:      newMetricsComponent(networkpolicies.ComponentName),
	}
}
