...
func initMetricComponentMap() map[metricName]*MetricsComponent {
	return map[metricName]*MetricsComponent{
		...
		appoperMetricName:              newMetricsComponent("applicationOperator"),
		istioMetricName:                newMetricsComponent("istio"),
		weblogicMetricName:             newMetricsComponent("weblogicOperator"),
		nginxMetricName:                newMetricsComponent("ingress"),
		certmanagerMetricName:          newMetricsComponent("certManager"),
		clusterOperatorMetricName:      newMetricsComponent("clusterOperator"),
		externaldnsMetricName:          newMetricsComponent("dns"),
		rancherMetricName:              newMetricsComponent("rancher"),
		verrazzanoMetricName:           newMetricsComponent("verrazzano"),
		vmoMetricName:                  newMetricsComponent("verrazzano-monitoring-operator"),
		opensearchMetricName:           newMetricsComponent("opensearch"),
		opensearchdashboardsMetricName: newMetricsComponent("opensearch-dashboards"),
		grafanaMetricName:              newMetricsComponent("grafana"),
		coherenceMetricName:            newMetricsComponent("coherenceOperator"),
		mysqlMetricName:                newMetricsComponent("keycloak.mysql"),
		mysqlOperatorMetricName:        newMetricsComponent("mySQLOperator"),
		keycloakMetricname:             newMetricsComponent("keycloak"),
		kialiMetricName:                newMetricsComponent("kiali"),
		promoperatorMetricname:         newMetricsComponent("prometheusOperator"),
		promadapterMetricname:          newMetricsComponent("prometheusAdapter"),
		kubestatemmetricsMetricName:    newMetricsComponent("kubeStateMetrics"),
		pushgatewayMetricName:          newMetricsComponent("prometheusPushgateway"),
		promnodeexporterMetricname:     newMetricsComponent("prometheusNodeExporter"),
		jaegeroperatorMetricName:       newMetricsComponent("jaegerOperator"),
		consoleMetricName:              newMetricsComponent("verrazzano-console"),
		...
		networkpoliciesMetricName:      newMetricsComponent("verrazzanoNetworkPolicies"),
	}
}
