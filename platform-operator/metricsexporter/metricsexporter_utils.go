...
func initMetricComponentMap() map[metricName]*MetricsComponent {
	return map[metricName]*MetricsComponent{
		...
		nginxMetricName:                newMetricsComponent("ingressNGINX"),
		...
		vmoMetricName:                  newMetricsComponent("verrazzanoMonitoringOperator"),
		opensearchMetricName:           newMetricsComponent("opensearch"),
		opensearchdashboardsMetricName: newMetricsComponent("opensearchDashboards"),
		...
		consoleMetricName:              newMetricsComponent("console"),
		fluentdMetricName:              newMetricsComponent("fluentd"),
		veleroMetricName:               newMetricsComponent("velero"),
		rancherBackupMetricName:        newMetricsComponent("rancherBackup"),
