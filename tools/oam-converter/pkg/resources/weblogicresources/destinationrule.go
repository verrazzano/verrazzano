...
func createDestinationFromRuleOrWeblogicWorkload(rule vzapi.IngressRule, weblogicWorkload *vzapi.VerrazzanoWebLogicWorkload) (*istio.HTTPRouteDestination, error) {
