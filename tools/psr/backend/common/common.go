...
var _ spi.ComponentContext = componentContext{}

// NewContext creates a ComponentContext from a raw CR
func NewContext(log vzlog.VerrazzanoLogger, c clipkg.Client, actualCR *v1alpha1.Verrazzano, actualV1beta1CR *v1beta1.Verrazzano, dryRun bool) (spi.ComponentContext, error) {
	return componentContext{
		...
		effectiveCRv1beta1: actualV1beta1CR,
	}, nil
}
...
func (c componentContext) Copy() spi.ComponentContext {
	return componentContext{
		log:         c.log,
		client:      c.client,
		dryRun:      c.dryRun,
...
func (c componentContext) Init(compName string) spi.ComponentContext {
...
func (c componentContext) Operation(op string) spi.ComponentContext {
