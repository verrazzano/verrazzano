...
var knownIssues = map[string]Issue{
	...
	NamespaceCurrentlyInTerminatingStateUnknownDuration: {Type: NamespaceCurrentlyInTerminatingStateUnknownDuration, Summary: "A namespace within the cluster has been in a terminating state for an unknown duration of time", Informational: true, Impact: 5, Confidence: 5},
}
