...
func TestInvalidIssues(t *testing.T) {
	...
	reportCtx := helpers.ReportContext{ReportFile: "report", ReportFormat: constants.SummaryReport, IncludeSupportData: true, IncludeInfo: true, MinConfidence: 8, MinImpact: 8, PrintReportToConsole: true}
