...
const (
	...
	SkipOperatorInstallFlag     = "skip-operator-install"
	SkipOperatorInstallShort    = "o"
	SkipOperatorInstallFlagHelp = "Installing the operator is skipped, but continues on to install Verrazzano."
	VerboseFlag                 = "verbose"
