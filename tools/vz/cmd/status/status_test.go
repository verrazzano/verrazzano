...
func TestStatusCmd(t *testing.T) {
	...
	templateMap := map[string]string{
		...
		"comp_grafana_state":                       string(vzapi.CompStateReady),
		"comp_verrazzanomonitoringoperator_state":  string(vzapi.CompStateReady),
		"comp_verrazzanoauthproxy_state":           string(vzapi.CompStateReady),
