...
require (
	...
	github.com/crossplane/oam-kubernetes-runtime v0.3.2 // indirect
	...
	github.com/verrazzano/verrazzano-monitoring-operator v0.0.29-0.20220324154616-c5e6f9e0fead // indirect
