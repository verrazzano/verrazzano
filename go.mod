...
require (
	...
	github.com/oracle/cluster-api-provider-oci v0.13.0
	...
	github.com/verrazzano/verrazzano-modules v0.0.0-20230817194054-1ec381226089
...
replace (
	...
	sigs.k8s.io/cluster-api => sigs.k8s.io/cluster-api v1.3.3
