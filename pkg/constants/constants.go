...
// VerrazzanoClusterRancherUser is the name for the Rancher cluster user used for managed cluster resource interaction
...
const VerrazzanoClusterRancherName = "verrazzano-cluster-rancher-user"
