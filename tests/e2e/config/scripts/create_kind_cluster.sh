...
create_kind_cluster() {
  ...
  HTTP_PROXY="${ORACLE_PROXY}" HTTPS_PROXY="${ORACLE_PROXY}" http_proxy="${ORACLE_PROXY}" https_proxy="${ORACLE_PROXY}" time kind create cluster --retain -v 1 --name ${CLUSTER_NAME} --config=${KIND_CONFIG_FILE}
