...
const (
	...
	coreURLFmt             = "https://github.com/verrazzano/cluster-api/releases/v%s/core-components.yaml"
	ocneBootstrapURLFmt    = "https://github.com/verrazzano/cluster-api-provider-ocne/releases/v%s/bootstrap-components.yaml"
	ocneControlPlaneURLFmt = "https://github.com/verrazzano/cluster-api-provider-ocne/releases/v%s/control-plane-components.yaml"
	ociInfraURLFmt         = "https://github.com/oracle/cluster-api-provider-oci/releases/v%s/infrastructure-components.yaml"
