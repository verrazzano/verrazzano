...
func getOpenSearchDashboardsURL(kubeconfigPath string) string {
	...
	isMinversion170, _ := IsVerrazzanoMinVersion("1.7.0", kubeconfigPath)
	...
	for _, ingress := range ingressList.Items {
		if (isMinversion170 && ingress.Name == "opensearch-dashboards") || (isMinversion150 && ingress.Name == "vmi-system-osd") || (!isMinversion150 && ingress.Name == "vmi-system-kibana") {
