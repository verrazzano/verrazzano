...
go test -coverprofile ./coverage.cov $(go list ./... | grep -Ev github.com/verrazzano/verrazzano/application-operator/test/integ | grep -Ev github.com/verrazzano/verrazzano/application-operator/mocks)
