...
const (
	...
	// PokoMutatingWebhookName is the resource name for the Verrazzano MutatingWebhook for plain old kubernetes pods
	PokoMutatingWebhookName = "verrazzano-application-poko-workload"
