...
import (
	...
	scheme "github.com/verrazzano/verrazzano/application-operator/clients/poko/clientset/versioned/scheme"
...
type MetricsTemplateInterface interface {
	...
	UpdateStatus(ctx context.Context, metricsTemplate *v1alpha1.MetricsTemplate, opts v1.UpdateOptions) (*v1alpha1.MetricsTemplate, error)
...
func newMetricsTemplates(c *PokoV1alpha1Client, namespace string) *metricsTemplates {
...
func (c *metricsTemplates) UpdateStatus(ctx context.Context, metricsTemplate *v1alpha1.MetricsTemplate, opts v1.UpdateOptions) (result *v1alpha1.MetricsTemplate, err error) {
	result = &v1alpha1.MetricsTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("metricstemplates").
