...
// +kubebuilder:webhook:admissionReviewVersions={"v1","v1alpha1"},verbs=create;update;delete,path=/appconfig-defaulter,mutating=true,failurePolicy=fail,groups=core.oam.dev,resources=ApplicationConfigurations,sideEffects=NoneOnDryRun,versions=v1alpha2,name=appconfig-defaulter.kb.io
