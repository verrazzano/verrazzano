...
func (m *MockFluentdManager) Apply(arg0 *LoggingInfo, arg1 v1alpha1.QualifiedResourceRelation, arg2 *FluentdPod) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockFluentdManager) Remove(arg0 *LoggingInfo, arg1 v1alpha1.QualifiedResourceRelation, arg2 *FluentdPod) bool {
	m.ctrl.T.Helper()
