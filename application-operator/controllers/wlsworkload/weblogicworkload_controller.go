...
func (r *Reconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	if err = r.restartDomain(ctx, &existingDomain, u, workload.Annotations[appconfig.RestartVersionAnnotation], u.GetName(), workload.ObjectMeta.Labels[oam.LabelAppName], workload.Namespace, log); err != nil {
		return reconcile.Result{}, err
	}
