...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkPolicyTempate) DeepCopyInto(out *NetworkPolicyTempate) {
	*out = *in
	in.Metadata.DeepCopyInto(&out.Metadata)
	in.Spec.DeepCopyInto(&out.Spec)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkPolicyTempate.
func (in *NetworkPolicyTempate) DeepCopy() *NetworkPolicyTempate {
	if in == nil {
		return nil
	}
	out := new(NetworkPolicyTempate)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ProjectTemplate) DeepCopyInto(out *ProjectTemplate) {
	*out = *in
	...
	if in.NetworkPolicies != nil {
		...
		*out = make([]NetworkPolicyTempate, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
