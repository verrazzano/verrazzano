...
CERT_MANAGER_TAG=1.2.0-20210510184928-aac6bdf62
CERT_MANAGER_RELEASE=1.2.0
CERT_MANAGER_HELM_CHART_VERSION=1.2.0
CERT_MANAGER_SOLVER_IMAGE=ghcr.io/verrazzano/cert-manager-acmesolver
CERT_MANAGER_SOLVER_TAG=1.2.0-20210510185040-aac6bdf62
...
NGINX_INGRESS_CONTROLLER_TAG=0.46.0-20210510134749-abc2d2088

NGINX_DEFAULT_BACKEND_IMAGE=ghcr.io/verrazzano/nginx-ingress-default-backend
NGINX_DEFAULT_BACKEND_TAG=0.46.0-20210510134749-abc2d2088
