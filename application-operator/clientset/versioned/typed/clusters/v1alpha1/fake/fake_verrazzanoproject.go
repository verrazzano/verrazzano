...
var verrazzanoprojectsResource = v1alpha1.SchemeGroupVersion.WithResource("verrazzanoprojects")

var verrazzanoprojectsKind = v1alpha1.SchemeGroupVersion.WithKind("VerrazzanoProject")
