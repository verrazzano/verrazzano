...
var loggingtraitsResource = v1alpha1.SchemeGroupVersion.WithResource("loggingtraits")

var loggingtraitsKind = v1alpha1.SchemeGroupVersion.WithKind("LoggingTrait")
