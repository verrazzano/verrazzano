...
var metricstraitsResource = v1alpha1.SchemeGroupVersion.WithResource("metricstraits")

var metricstraitsKind = v1alpha1.SchemeGroupVersion.WithKind("MetricsTrait")
