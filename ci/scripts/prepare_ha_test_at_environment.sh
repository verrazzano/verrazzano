...
yq eval -i '.spec.components.opensearch.policies[0].rollover.minIndexAge = "1d"' "${INSTALL_CONFIG_FILE}"
...
yq eval -i '.spec.components.opensearch.policies[1].rollover.minIndexAge = "1d"' "${INSTALL_CONFIG_FILE}"
