...
yq eval -i '.spec.components.fluentOperator.enabled = true' ${INSTALL_CONFIG_FILE_KIND}
yq eval -i '.spec.components.fluentbitOpensearchOutput.enabled = true' ${INSTALL_CONFIG_FILE_KIND}
