                    ...
                    post {
                        always {
                            ...
                            sh """
                                ...
                                kubectl logs --selector=job-name=verrazzano-install-my-verrazzano -n verrazzano-install > ${WORKSPACE}/verrazzano/platform-operator/scripts/install/build/logs/verrazzano-install.log --tail -1
                                kubectl describe pod --selector=job-name=verrazzano-install-my-verrazzano -n verrazzano-install > ${WORKSPACE}/verrazzano/platform-operator/scripts/install/build/logs/verrazzano-install-job-pod.out
