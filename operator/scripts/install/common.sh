...
COHERENCE_OPERATOR_IMAGE_REPO=ghcr.io/oracle/coherence-operator
COHERENCE_OPERATOR_IMAGE_TAG=3.1.1

VERRAZZANO_APPLICATION_OPERATOR_IMAGE_REPO=phx.ocir.io/stevengreenberginc/kminder/verrazzano-application-operator-dev
VERRAZZANO_APPLICATION_OPERATOR_IMAGE_TAG=local-e870083-20210114055733
