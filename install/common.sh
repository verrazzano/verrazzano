...
NGINX_INGRESS_CONTROLLER_IMAGE=phx.ocir.io/stevengreenberginc/bfs/ingress-nginx-controller
NGINX_INGRESS_CONTROLLER_TAG=0.32-0
NGINX_INGRESS_CONTROLLER_VERSION=1.27.0

NGINX_DEFAULT_BACKEND_IMAGE=phx.ocir.io/stevengreenberginc/bfs/ingress-nginx/custom-error-pages
