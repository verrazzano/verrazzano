...
.PHONY: copyright-fix
copyright-fix: copyright-test ## check copyright notices have correct current year
...
copyright-check: copyright-test copyright-fix  ## check copyright notices are correct
